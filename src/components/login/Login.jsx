...
export default function Login() {
  ...
  return (
    <div className='formContainer relative'>
        <div className='flex flex-col items-center justify-center gap-5  m-auto w-[400px] h-[550px] bg-slate-400 opacity-50 absolute top-36 right-0 left-0 rounded-xl'>
